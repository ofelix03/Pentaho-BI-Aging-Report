DROP FUNCTION IF EXISTS odoo14.corrected_aging_receivable_detailed(
  CHARACTER VARYING, 
  INTEGER, 
  DATE, 
  CHARACTER VARYING
...
CREATE OR REPLACE FUNCTION odoo14.corrected_aging_receivable_detailed(
...
COMMENT ON FUNCTION odoo14.corrected_aging_receivable_detailed(CHARACTER VARYING, INTEGER, DATE, CHARACTER VARYING) IS $$
  This function provides detailed aging receivable with partner filtering and feature to change date interval.

  SIGNATURE
  ---------
  odoo14.corrected_aging_receivable_detailed(
    IN p_schema CHARACTER VARYING,
    IN p_interval INTEGER,
    IN p_date DATE,
    IN p_partner_ids CHARACTER VARYING
  ...
  1. SELECT partner_id, partner_name, days, "date", "ref", intv0, intv1, intv2, intv3, intv4, intv5, balance
       FROM odoo14.corrected_aging_receivable_detailed('fdw_sagedistribution_14', 30, '2019-09-03', '(0)');

  2. SELECT partner_id, partner_name, days, "date", "ref", intv0, intv1, intv2, intv3, intv4, intv5, balance
       FROM odoo14.corrected_aging_receivable_detailed('fdw_sagedistribution', 30, '2019-09-03', '(2850, 2582, 2429, 2759, 2577, 2859, 2574, 2545, 2776, 2414)');
